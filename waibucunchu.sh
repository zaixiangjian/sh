...
tar -czvf /home/网盘/wangpan_$(date +%Y%m%d%H%M%S).tar.gz -C /home/docker wangpan
...
#                                                                                         别忘记哈希加密
ls -t /home/网盘/*.tar.gz | head -1 | xargs -I {} sshpass -p 'vps密码' scp -o StrictHostKeyChecking=no -P 22 {} root@vpsip:/home/网盘



# Keep only 5 tar archives in /home/beifen/ and delete the rest
cd /home/密码/ && ls -t *.tar.gz | tail -n +10 | xargs -I {} rm {}
cd /home/网盘/ && ls -t *.tar.gz | tail -n +10 | xargs -I {} rm {}
