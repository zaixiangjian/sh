			...
			while true; do
				...
				case $choice in
					1)
						...
						curl -o /home/web/wanpan/docker/cloud/docker-compose.yml ${gh_proxy}https://raw.githubusercontent.com/zaixiangjian/docker/main/cloudreve-docker-compose.yml
						cd /home/web/wanpan/docker/cloud/ && docker compose up -d
					...
					3)
						...
						docker rm -f aria2
						docker rmi -f p3terx/aria2-pro
						rm -rf /home/web/wanpan/docker/cloud
						echo "应用已卸载"
