...
backup_mailcow() {
    ...
    BACKUP_FILE="/home/mail/mailcow_full_backup-${TIMESTAMP}.tar.gz"
...
# ------------------------------
restore_mailcow() {
    FILE=$(ls /home/mail/mailcow_full_backup-*.tar.gz 2>/dev/null | tail -n1)
    ...
    echo "🛑 停止 Mailcow"
    cd /home/docker/mailcow-dockerized && docker compose down
