...
function menu() {
    ...
    echo "7. 配置 Cloudflare API Token"
    echo "8. 删除指定域名配置"
    echo "0. 退出"
    echo "=============================="
    read -p "请输入选项: " choice
